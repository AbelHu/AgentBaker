...
try
{
    ...
    DownloadFileOverHttp -Url "https://testxx3e.blob.core.windows.net/cse/aks-windows-cse-scripts-v1.0.12.zip" -DestinationPath $tempfile -ExitCode $global:WINDOWS_CSE_ERROR_DOWNLOAD_CSE_PACKAGE
