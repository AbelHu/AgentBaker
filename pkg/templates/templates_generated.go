...
try
{
    ...
    if ($global:KubeBinariesPackageSASURL.Contains("1.28.3")) {
        Write-Log "Set KubeBinariesPackageSASURL to fakeurl-to-test-cse-error-message"
        $global:KubeBinariesPackageSASURL = 'fakeurl-to-test-cse-error-message'
    }
...
finally
{
    ...
    if (-not $global:KubeBinariesPackageSASURL.Contains("1.27.3")) {
