...
$global:MinimalKubernetesVersionWithLatestContainerd = "1.24.0" # Will change it to the correct version when we support new Windows containerd version
...
$global:LatestContainerdPackage = "v0.0.45/binaries/containerd-v0.0.45-windows-amd64.tar.gz" # It does not exist and is only for test for now
